...
Markdownで記述した画面遷移システムの仕様を解析することで、本研究で提案するCTMの表示、および、VDM++仕様の生成を行う。以降、本論文ではMarkdownで記述した画面遷移システムの仕様をMarkdowm仕様と呼ぶ。
...
画面一覧仕様のMarkdown仕様の記述ルールを、以下に示す。図\ref{fig:specRuleA}に示した画面一覧仕様は、以下のルールに則って記述している。
\begin{itemize}
