...
本章では、拡張した\tool の機能について説明する。拡張部分では、以下の3つの機能を提供する。
\begin{itemize}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\centering\arraybackslash}m{3.5cm}|>{\centering\arraybackslash}m{6cm}|}
    ...
    \hline
    タイムアウト & \includegraphics[width=0.4\linewidth]{./images/タイムアウト.png} \\
    \hline
    遷移先のないイベント & \includegraphics[width=0.8\linewidth]{./images/遷移エラー.png}\\
    \hline
  \end{tabular}
\end{table}
