...
%  backgroundcolor={\color[gray]{.9}},%背景色の指定
  basicstyle={\small\ttfamily \color[gray]{.15}},%書体の指定
  identifierstyle={\ttfamily \color[cmyk]{1,0,0,0}},%識別子の書体
  keywordstyle={\ttfamily},%言語ワードの書体
  % keywordstyle={\ttfamily \color[cmyk]{0,1,0,0}},%言語ワードの書体
  stringstyle={\small\ttfamily},%文字列リテラルの書体
  % stringstyle={\small\ttfamily \color[rgb]{0,0,1}},%文字列リテラルの書体
  commentstyle={\itshape \color[cmyk]{1,0,1,0}},%コメントの書体
  numberstyle={\small},%行番号の書式
